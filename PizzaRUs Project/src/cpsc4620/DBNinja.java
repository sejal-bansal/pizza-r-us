...
public final class DBNinja {
    ...
    public static int addCustomer(Customer customer) throws SQLException, IOException {
        connect_to_db();
        /*
        ...
        String insertStatement = "INSERT into customer(CustomerFirstName, CustomerLastName, CustomerPhone) VALUES (?,?,?)";
    ...
    public static ArrayList<Customer> getCustomerList() throws SQLException, IOException {
        ...
        try (Statement statement = conn.createStatement();
            ...
            while (resultSet.next()) {
                ...
                String customerFirstName = resultSet.getString("CustomerFirstName");
